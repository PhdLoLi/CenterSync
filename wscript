...
def build(bld):
    ...
    os.system('protoc -I=libcsync --python_out=script libcsync/csync.proto')
    bld.stlib(source=bld.path.ant_glob(['libcsync/*.proto', 'libcsync/cclient.cpp', 'libcsync/cserver.cpp']), 
              target="csync",
              includes=". libcsync",
    ...
    bld.install_files('${PREFIX}/include', 
                      bld.path.ant_glob('include/csync/*.hpp'))

    bld(features='subst', source='csync.pc.in', 
        target = 'csync.pc', encoding = 'utf8', 
